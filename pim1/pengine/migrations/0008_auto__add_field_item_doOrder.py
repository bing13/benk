...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.doOrder'
        db.add_column('pengine_item', 'doOrder', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Item.doOrder'
        db.delete_column('pengine_item', 'doOrder')
    ...
    models = {
        'pengine.item': {
            ...
            'doOrder': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.projType'
        db.alter_column('pengine_project', 'projType', self.gf('django.db.models.fields.CharField')(max_length=20))


    def backwards(self, orm):
        
        # Changing field 'Project.projType'
        db.alter_column('pengine_project', 'projType', self.gf('django.db.models.fields.IntegerField')())

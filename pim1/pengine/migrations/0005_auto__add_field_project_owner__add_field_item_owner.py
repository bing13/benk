...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('pengine_project', 'owner', self.gf('django.db.models.fields.CharField')(default='djangosuper', max_length=30), keep_default=False)

        # Adding field 'Item.owner'
        db.add_column('pengine_item', 'owner', self.gf('django.db.models.fields.CharField')(default='djangosuper', max_length=30), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.owner'
        db.delete_column('pengine_project', 'owner')

        # Deleting field 'Item.owner'
        db.delete_column('pengine_item', 'owner')
